...
export function isSwiperCards() {
	let sliders = document.querySelectorAll('._swiper');
		...
		let slider_about = new Swiper('.products-slider__slider', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
...
export function isSwiperNew() {
	let sliders = document.querySelectorAll('._swiper');
		...
		let slider_about = new Swiper('.products-new__swiper', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
